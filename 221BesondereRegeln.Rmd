...
Jeder Kern kommt mit passendem Ressonanzkreis, entweder als Schmuckstück der Wahl oder als Tattoo für einen Aufpreis von 3.000 Reiks. XXXXCrossreferenz Ressonanzlore (kontrolle)
...
-   Fähigkeitsmaximum: die Eigenschaft Utility reduziert den Preis um den Faktor 0,25 jedoch wird das Skilllevel auf 50 limitiert xxxCrossreferenz XXXX
...
Außerdem können während der Session Essenzen genutzt werden, um die Batterie neu zu befüllen. xxxCROSSREFERENCE (siehe Batterie in Session Aufladen)
