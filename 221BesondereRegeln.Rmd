...
-   Verbaute Artillerie-Nutzung durch Person
...
-   Alle weiteren Funktionen, die nicht explizit mehrere Ladungen erfordern

\*Nur Standartfunktionen hier, ansonsten crossreferenz zu addons (siehe X)

*2 Ladungen*

-   Besondere Waffentypen (Bsp. Flammenwerfer)x

-   Schwerer Angriff mit jeder Nahkampfwaffe erlaubtx
...
Alternativ zum Kauf ist es möglich, mit dem richtigen handwerklichen Geschick, ein Konstrukt selbst zu bauen. Hierfür sind Konstruktteile, diese bestehen aus je zwei Material des passenden Materials, benötigt. Es wird 1 Konstruktteil pro Größe verbraucht.
