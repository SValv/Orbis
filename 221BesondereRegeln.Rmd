...
+-------------------+------------------------+---------+-------+------------------------------------------------------------------------------------------------------+
| Werkzeug          | zusätzliche <br>Checks | Gewicht | Preis | Anmerkung                                                                                            |
+===================+:======================:+:=======:+:=====:+:====================================================================================================:+
| Retorte           | 1                      | 1       |       |                                                                                                      |
+-------------------+------------------------+---------+-------+------------------------------------------------------------------------------------------------------+
...
+-------------------+------------------------+---------+-------+------------------------------------------------------------------------------------------------------+
| Messer            | 1                      | 0.5     |       | kann auch als Alchemiewerkzeug verwendet werden                                                      |
+-------------------+------------------------+---------+-------+------------------------------------------------------------------------------------------------------+
| Feuerkatalysator  | 1                      | 1       |       | kann auch als Alchemiewerkzeug verwendet werden                                                      |
+-------------------+------------------------+---------+-------+------------------------------------------------------------------------------------------------------+
| Drachenatem       | 3                      | 3       |       | Ersetzt Feuerkatalysator<br>kann auch als Alchemiewerkzeug verwendet werden                          |
+-------------------+------------------------+---------+-------+------------------------------------------------------------------------------------------------------+
...
Ausrüstung verliert über die Zeit Zustand. Mit der Aktion Reparieren stellt man den Zustand wieder her. eine Reperatur verbraucht pro reperierten Zustand 0,1 Material unabhängig von Wert der Ausrüstung.

| Reparieren | Threshold | Materialkosten |
|:----------:|:---------:|:--------------:|
|  Stufe 1   |    1,5    |      1000      |
|  Stufe 2   |    2,3    |      3000      |
|  Stufe 3   |     3     |      6000      |
...
|  Stufe  | Threshold | Materialkosten |
|:-------:|:---------:|:--------------:|
| Stufe 1 |    2,4    |      1000      |
| Stufe 2 |    3,3    |      3000      |
| Stufe 3 |     4     |      6000      |
...
## Musik und ihre Wirkung im Kampf {#InstrumenteRules}
...
In der Welt von Orbis Astea werden Schweiss und Tränen für den großen Gewinn nicht nicht nur auf dem Schlachtfeld vergossen. Ebenso große Siege kann mit etwas Glück auch ein geschickter Händler erzielen.

Bei dieser nebenaktivität die hauptsächlich in der Downtime und am Anfang von Sessions ausgeübt wird ist jeder Spieler seines eigenen Glückesschmied. Diverse Handelswaren können im Regionalen Handelskontor erworben oder verkauft werden, seien es nun unter Blutvergießen erworbenen Monstertrophäen, geschickte Handwerksarbeiten des Schmieds der Gruppe oder hochpreisiger Wein von den Hängen der Himmelsspitzen. Doch seit gewarnt die Preise dieser Güter sind kein feststehender Betrag wie es für bei normalen Items der Fall ist, die Preise ändern sich quasi täglich. Man muss jedoch nicht fürchten das der Schatz des einen Tages wertloser Plunder am nächsten ist, jedoch Schwanken die Preise mancher Waren mehr als andere.

Das Regionale Handelskontor steht allen Spielern so wie andere Händler jederzeit offnen, kann jedoch im gegenzug zu den anderen Händlern nicht über eine Excel Datei bedient werden sondern nur in Interaktion mit dem DM in der DM-App. Da jeder Händler unterschiedlich viel Waren anbieten kann und auch nur einen begrenzt gefüllten Geldbeutel bestitzt, dieser lässt sich natürlich aber leicht mit dem kauf von Waren aufstocken.

Handelswaren werden in 1KG Einheiten verkauft.

### Handelswaren

+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Handelswaren       | Startpreis | Preisschwankung | Beschaffung                                                                              | Beschreibung                                                                                                          |
+====================+============+=================+==========================================================================================+=======================================================================================================================+
| Schmiedewaren      | 200        | Mittel          | Aus T1 Material geschmiedet, zwischen 1-10 Stück Pro herstellung möglich                 | Eisenwaren wie Schaufeln, Mistgabeln und co.                                                                          |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Edelmetalle        | 300        | Hoch            | Seien es nun Minen oder Flüsse diese Metalle findest du nur mit Glück und harter Arbeit. | Gold, Silber und weitere Seltene aber nutzlose Erze.                                                                  |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Schmuck            | 1000       | sehr Hoch       | Aus Edelmetallen Hergestellt. 1KG=1KG Schmuck bei erfolgreichen Schmieden                | Gold und Silberschmuck feinster Qualität.                                                                             |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Vorräte            | 50         | sehr niedrig    | Kann in der Downtime Erjagt werden.                                                      | Alles was ein Abenteurer zu seiner Versorgung braucht.                                                                |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Monsterkurisitäten | 500        | sehr Hoch       | Wer Monsterjagt wird mit etwas Glück eine Trophäe nach Hause bringen.                    | Sei es jetzt ein Werwolfschädel oder ein Drachenhorn, alles das Interesse weckt kann verkauft werden.                 |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Gewürze            | 800        | Hoch            | Industriell Hergestellt                                                                  | die Würze im Leben sei es nun Salz oder seltener Pfeffer, was auch immer der Gaumen begehrt.                          |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Stoffe             | 200        | Mittel          | Industriell Hergestellt                                                                  | Seltene Seiden und andere Stoffe                                                                                      |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Alkohol            | 100        | Mittel          | Industriell Hergestellt                                                                  | Edle Tropfen seien es nun Hochwertige Weine von den Berghängen oder hochprotzeniger Schnaps von den Norsen Highlands. |
+--------------------+------------+-----------------+------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+

### Regionale Unterschiede

Eine kleiner Händler der sich in seinem Dorf zur Ruhe gesetzt hat kann immer noch gutes Geld mit dem Handel erzielen, jedoch die wahren großen Gewinne liegen bei fahrenden Händlern die Geschickt die Preis unterschiede der Nachfrage in verschiedenen Regionen auszunutzen Wissen. So wird einem teurer Schmuck im Herzland von den Edlen Damen quasi aus der Handgerissen aber ebenso werden in den mit Weizen gefüllten Tälern von Yondalla die Händler wenig mit euren Vorräten anzufangen Wissen.
...
Auch Fernkampfwaffen sind auf See deutlich häufiger vertreten - dabei allen voran Armbrüste und Musketen, deren größter Nachteil, die Nachladezeit, von der Distanz von Schiff zu Schiff relativ gut negiert wird.
...
Konstrukte - die größten Wunder mechanischer Handwerkskunst - stellen den Zenit der zwergischen Innovation dar. Sie sind als einziges Volk in der Lage diese, teils tonnenschweren, Kolosse zum Leben zu erwecken. Die Konstrukte existieren in allen Formen und Farben und decken jeden nur möglichen Arbeitsbereich ab. So stellen sie zum Beispiel einen der schlagkräftigsten Teile des Rah' Kari Heeres dar, werden von Zwergenkarawanen zum Transport von unglaublich schweren Waren benutzt und sind gleichzeitig mit schweren Ballisten bestückt. Fast jede Tätigkeit, die ein Konstrukt übernimmt, könnte genauso gut durch ein Tier, eine schlichte Mechanik oder einfach nur durch eine Person übernommen werden. Doch Konstrukte bieten, neben vielen anderen Vorteilen, einen bestimmten: bedingungslose Loyalität. Dies macht sie für Personen mit dem richtigen "Kleingeld" im Beutel zu attraktiven Begleitern.

### Kontrolle {#KonstruktResonanz}

Kein Konstrukt wird seinen Meister willentlich hintergehen, denn sie sind in Ermangelung von eben diesem. Wer einem Konstrukt Befehle geben kann, wird, durch einen so genannten Meisterstein, klar geregelt. Dieser wird zusammen mit dem Konstruktkern erschaffen und erhält dabei ein einmaliges Muster. Dieses Muster steht in Resonanz mit dem Kern, der das gleiche Muster trägt. Die Reichweite dieser Resonanz ist dabei jedoch begrenzt. Innerhalb dieser Distanz führt das Konstrukt allerdings jeden Befehl aus, der vom Besitzer des Meistersteins gegeben wird. Dabei muss dieser Befehl nicht laut gesagt werden, ein expliziter Gedanke reicht bereits aus. So wichtig die Reichweite ist, als Meister sollte man sich da nichts so viele Sorgen machen, sollte ein Konstrukt die Reichweite verlassen so durchläuft das Konstrukt die aktuelle Routine fertig / führt den Befehl zu Ende aus. Anschließend startet das Konstrukt automatisch eine vorher bestimmte Verhaltensroutine, wie Rückkehr zum Besitzer des Meistersteins, Kampf oder Flucht. Der Meisterstein kann, trotz seines Namens vielerlei Form haben, da das Muster erst bei der Erschaffung des Kerns auf-geprägt wird. Mögliche Meistersteine wären so zum Beispiel ein Amulett, Armreif oder tatsächlich ein verzierter Stein. In seltenen Fällen kann von Meistern ihres Handwerks das Muster sogar auf die Haut als Tattoo aufgetragen werden. Solche Tattoos bringen Vorteile wie Nachteile, so ist es quasi unmöglich die Kontrolle über das Konstrukt zu übertragen, im Gegenzug ist es jedoch auch quasi unmöglich den Meisterstein von seinem Besitzer zu entwenden. Dies wird also nur von den misstrauischsten Zwergen genutzt. Zu beachten ist jedoch, dass die Nutzung von Konstrukten pro Meister limitiert ist, denn zu viele Meistersteine unter einem Meister stören sich bei der Resonanz gegenseitig.

### Essenzen

Essenzen stellen eine mysteriöse Energiequelle dar, welche mit einem Nadel ähnlichen Mechanismus aus frisch Verstorbenen extrahiert wird. Diese Energiequelle benötigt besondere Aufbewahrung und kann derzeit nur für bestimmte Dinge verwendet werden. Was mit ihr erreicht werden kann, scheint jedoch weit über den Entwicklungsstand der aktuellen Zivilisation hinauszugehen.

Mit ihr können Konstruktkerne Konstruiert und sogar weiter verbessert werden. Des Weiteren nutzen Konstrukte sie je nach Anwendung als Antrieb sei es langfristig in Batterien oder als kurzfristiger Ladungsboost.
...
## Konstrukte Regeln {#Konstruktregeln}

### Kampf

Ein Konstrukt folgt den Befehlen seines Meisters im Kampf, sollte dieser nicht zur Verfügung stehen folgt es entweder dem letzten geäußerten Befehl oder einer einfachen Standardroutine. Befehle können entweder verbal oder sogar gedanklich übermittelt. Ein Konstrukt ist demnach also nicht zu komplexen eigenständigem Denken fähig.

Ein Konstrukt hat, wie die Spieler der Kampagne, zwei Aktionen pro Runde. Vorausgesetzt genügend Ladungen sind verfügbar, besteht die Chance auf eine dritte Aktion pro Runde (siehe [Vehikel-Check](#Fahrzeuge)).
...
Jedes Konstrukt besteht aus 6 angreifbaren Teilen, seinen 4 Gliedmaßen, einer Kernabdeckung und dem Kern selbst. Der Kern für sich ist nahezu ungepanzert, kann jedoch erst angegriffen werden *nachdem* die Kernabdeckung zerstört wurde. Der Kern ersetzt beim gezielten Angriff den Kopf und die Kernabdeckung den Torso.

### Ladungen

Ladungen werden in der Batterie gespeichert. Jede aktive Aktion verbraucht Ladungen der Batterie. Je nach Art der Anwendung, können auch mehrere Ladungen für eine Anwendung verbraucht werden. Normale Handlungen, wie gehen oder Ausschau halten, sind Gratis.

Während der Downtime lädt sich die Batterie zu 100% von selbst wieder auf.

### Anwendungen für Ladungen

+------------------------------+--------------------------------------------------------------------+------------------------------------------+
| 1 Ladung (Standartanwendung) | 1 Ladung (nur mit Addons)                                          | 2 Ladungen                               |
+==============================+====================================================================+==========================================+
| Angriff                      | Schützen (für jemanden Blocken)                                    | Schwerer Angriff mit jeder Nahkampfwaffe |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+
| Sprint                       | Rammen                                                             | Besondere Waffentypen                    |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+
| Blocken                      | umwerfen (Grappling)                                               |                                          |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+
| Dodgen                       | Verbaute Attilerie Nutzung                                         |                                          |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+
| Klettern                     | Seilwerfer                                                         |                                          |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+
|                              | Rauchwerfer                                                        |                                          |
...
|                              | Bolawerfer                                                         |                                          |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+
|                              | \*Alle weitere Funktionen die nicht expliziet 2 Ladungen erfordern |                                          |
+------------------------------+--------------------------------------------------------------------+------------------------------------------+

### Vehikel Fähigkeit {#VehikelFähigkeitKonstrukt}

Dem Besitzer des Konstrukts ist es möglich kurzzeitig die Kontrolle über ein Konstukt auch aus der Entfernung zu übernehmen, dies äußert sich in einer zusätzlichen Aktion für das Konstrukt. Diese Aktion hängt von einem Vehikel Check ab, dessen schwierigkeit auf dem Kern und der Größe des Konstrukts basiert. Je stärker das Konstrukt, desto schwieriger die Kontrolle. Bei Erfolg wird die Main Action des Spielers aufgebraucht, bei Misserfolg die Single Action, da weniger Zeit verbraucht wird.

Die Schwierigkeit des Checks wird im Konstruktprofil automatisch berechnet. Die Schwierigkeit kann durch einen Pilotensitz im Konstrukt halbiert werden.CROSSREFERENCE XXXX

### Reparatur

Natürlich kommt es vor, dass Konstrukte im Kampf demoliert werden, also die Leben des Konstrukts auf 0 fallen. In diesem Fall muss es in der Downtime repariert werden.

Je nach Größe des Konstrukts, müssen zwischen eine bis drei Downtime Handwerk-Aktionen aufgewendet werden.

Der Schwierigkeitsgrad des Checks orientiert sich dabei an dem Tier des Korpus und den entsprechenden Reparaturwerten des Materials.

Jedoch benötigen diese Reparaturen *keine* Materialien.
...
Ein Konstrukt ist im Aufbau einem Spielercharakter nicht unähnlich, unterscheidet sich jedoch, neben einigen weiteren Zusätzen, in der Quelle der Attribute und Fähigkeitspunkte.

Ein Konstrukt besteht aus:

-   Konstrukt-Kern: das Herz und Hirn des Konstrukts bestimmt Leben und Fähigkeitspunkte.

-   Akku: gibt die Ladungsmenge, also die Anzahl an möglichen Aktionen des Konstrukts, vor.

-   Korpus: gibt die verfügbaren Attribute und Rüstung vor.

Diese drei Komponenten müssen für ein funktionierendes Konstrukt immer vorhanden sein. Die einzelnen Teile können jedoch beliebig mit anderen Teilen der gleichen Klasse getauscht werden.
...
#### Fähigkeiten {#FähigkeitenKonstrukt}

Nicht alle Fähigkeiten können von Konstrukten entwickelt werden, da auch diese Grenzen haben.\
Folgende Fähigkeiten können verbessert werden:
...
Der Konstrukt-Kern stellt sowohl das Herz als auch das Hirn eines jeden Konstrukts dar. Das Level des Kerns wird durch das Anwenden von Essenzen in der Downtime erhöht. Dieses Level beeinflusst viele Bereiche des Konstrukts:

-   Die maximalen Attribute, die effektiv eingesetzt werden können. Sollten mehr Punkte in ein Attribut geflossen sein als die Stufe des Kerns, so werden nur die Attributpunkte bis zur Kernstufe angewandt.

-   Neben der Begrenzung durch die Maximalattribute, leveln auch zwei Attribute direkt mit der Kernstufe: Intelligenz im Faktor 1 zu 1 und Instinkt im Faktor 1 zu 0,75.

-   Die maximalen Leben des Konstrukts entsprechen der 15-fachen Kernstufe und verteilen sich unter den Gliedmaßen folgendermaßen: 50% Kern(Kopf), 50% Kernabschirmung (Torso), alle anderen Teile je 30%

-   Das Fähigkeiten-Grundlevel: mit jeder Kernstufe erhöht sich auch das Grundlevel einer jeden Fähigkeit. Sollte dieses höher sein als das verbesserte Level der Fähigkeit, wird für die Berechnung stattdessen das Grundlevel herangezogen.

-   Fähigkeitslevel: durch die Verwendung von Essenzen, unabhängig von der Stufe des Kerns, können einzelne Fähigkeiten verbessert werden.
...
Fähigkeitenlevel erhöhen nach Herstellung:

| Fähigkeitenlevel | Preis je Level | Gesamtpreis (Essenzen) |
|------------------|----------------|------------------------|
| 0-20             | 1              | 20                     |
| 21-40            | 2              | 60                     |
| 41-60            | 3              | 120                    |
...
*Essenzen können beim Kauf des Kerns für einen Preis von 500 Reiks pro Essenz direkt erworben werden.*

Jeder Kern kommt mit passendem Resonanzkreis also einer Steuereinheit, entweder als Schmuckstück der Wahl oder als Tattoo für einen Aufpreis von 5.000 Reiks.

Das Schmuckstück muss stehts am Körpergetragen werden um das Konstrukt zu befehligen, jedoch liegt es in der Natur der Sache das diese ein Strahlen in den Augen von gewieften Dieben auslösen. Dafür sind sie jedoch übertragbar.

Das Tattoo hingegen ist weder vererbar noch kann es gestohlen werden.

Die Auswahl der beiden Möglichkeiten erfolgt bei der Kauf des Kerns.

#### Corpus

Der Korpus bestimmt folgende Eigenschaften eines Konstrukts.

-   Größe: Klein, Mittel, Groß

-   Attributhöhe: je höher die Stufe, desto mehr Attribute können auf Särke, Agilität und Physis verteilt werden

-   Das vergeben von Attributspunkten verläuft linear, also kostet das Steigern eines Attributs um einen Punkt nur einen Punkt,
...
-   Grundtragekapazität: Diese wird automatisch berechnet und ist im Profil des jeweiligen Konstrukts nachzulesen.

+---------+---------+-----------+---------------+
|         | Rüstung | Attribute | Preis (Reiks) |
+:=======:+:=======:+:=========:+:=============:+
| Tier 1\ | 100     | 10        | 6.000         |
| klein   |         |           |               |
+---------+---------+-----------+---------------+
| Tier 2\ | 130     | 15        | 18.000        |
| klein   |         |           |               |
+---------+---------+-----------+---------------+
| Tier 3\ | 145     | 20        | 36.000        |
| klein   |         |           |               |
+---------+---------+-----------+---------------+
| Tier 4\ | 160     | 25        | 72.000        |
| klein   |         |           |               |
+---------+---------+-----------+---------------+
| Tier 1\ | 100     | 20        | 12.000        |
| mittel  |         |           |               |
+---------+---------+-----------+---------------+
...
Alternativ zum Kauf ist es möglich, mit dem richtigen handwerklichen Geschick, ein Konstrukt selbst zu bauen. Hierfür sind Konstruktteile, diese bestehen aus je zwei Material des passenden Materials, benötigt. Es wird 1 Konstruktteil pro Größe verbraucht. Das mischen von Material bei den Konstruktteilen ist dabei nicht möglich.

##### Attribute

Jedes Attribut startet standardmäßig auf 1 und kann durch den Korpus oder durch [Addons](#KonstruktAddons) erhöht werden. Addons sind jedoch auf Stärke, Agilität und Physis beschränkt. Mit dem Aufsteigen des Konstruktkernlevels erhöht sich außerdem der Wert von Instinkt und Intelligenz.

#### Batterie

Eine Batterie ist wie der Kern ein stetig stärker werdendes Element des Konstrukts, eine Batterie wird mit 0 Maximalen Ladungen erworben und kann entweder beim Schmied zu unten genannten Konditionen verbessert werden oder man verbessert die effizienz einfach direkt selbst über Handwerkschecks, jedoch sollte man beachten dass sich sowohl Preis als auch schwierigkeitsgrad dieses Tuning verfahrens erheblich steigern.

Außerdem können während der Session Essenzen genutzt werden, um die Batterie neu zu befüllen.

*Grundpreis: 5.000*

+---------------+--------------------------+-------------------------------+---------------------------------------------+
| Ladungsanzahl | Preis pro Ladung (Reiks) | Gesamt (inklusive Grundpreis) | Verbesserungsschwierigkeit (Handwerkscheck) |
+===============+==========================+===============================+=============================================+
| 1-5           | 500                      | 7500                          | 1,5                                         |
+---------------+--------------------------+-------------------------------+---------------------------------------------+
...
Zum Aufladen des Akkus ohne Pausen: Hierfür wird der Essenzsammler verwendet. Eine Ladung entspricht 10 Essenzen. Jedoch ist es schwer abzuschätzen, wann man die Sammler abziehen muss, weshalb es öfter zu ungenauen Abzügen kommt. Im schlimmsten Fall kann dies zum Verlust aller gesammelten Seelen im Sammler führen. Aufgrund des hohen Preises dieser Anwendung, wird diese nur im absoluten Notfall empfohlen.

### Erweiterungen: Waffen, Upgrades und zusätzliches

Ein Konstrukt kann bis zu 5 Erweiterungen jeglicher Art gleichzeitig ausrüsten.\
Egal ob es sich um Waffen, Addons oder Upgrades handelt.

Diese können entweder Käuflich erworben werden oder sogar mit den entsprechenden Materialien selbst hergestellt werden.

#### Upgrades:

Upgrades erhöhen entweder die Attribute, Panzerung oder Leben eines Konstrukts solange diese ausgerüstet sind.
...
Ein Konstrukt kann das vollständige Waffenarsenal verwenden, auf das auch Spieler zugreifen können. Zusätzlich noch einige weitere besondere Konstruktwaffen verwendet werden, wie den Kampfbohrer und den Flammenwerfer.

-   hier vielleicht ne übersicht über die waffen? können wir die Automatisieren?

#### Addons: {#KonstruktAddons}

+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Addons                  | Beschreibung                                                                                                                                                                                                | Stufe 1        | Stufe 2        | Stufe 3        | Stufe 4        |
+=========================+=============================================================================================================================================================================================================+================+================+================+================+
| Transport               | erhöht die Belastungsgrenzen des Transportgewichts                                                                                                                                                          | +75KG          | +125KG         | +200KG         | +300KG         |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Panzermodus             | 100% Passiv Blockchance jedoch keine Angriffe möglich                                                                                                                                                       | Schildwert +10 | Schildwert +15 | Schildwert +20 | Schildwert +30 |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Wachmodus               | Standartmäßig vorhanden benötigt jedoch Slot, Konstrukt steht Wache durch Perception Check                                                                                                                  |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Artillerie              | Nur von menschenhand bedienbare festmontierte Artillerie, jedoch einklappbar                                                                                                                                |                |                |                |                |
|                         |                                                                                                                                                                                                             |                |                |                |                |
|                         | nur im Festenstand zu nutzen                                                                                                                                                                                |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Schützenplatz           | Ermöglicht Artillerienutzung in der Bewegung und ohne abzusteigen, bietet zusätzlich Deckung für den Schützen                                                                                               |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Artillerienachlademodul | ermöglicht das Automatische Nachladen ohne das zutun des Schützen, verbraucht jedoch Ladungen                                                                                                               |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Fernkampfstellung       | ermöglicht es Fernkämpfern auf dem Konstrukt stellung zu beziehen und Deckung zu suchen (nur bei großen Konstrukten möglich)                                                                                |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Pilotensitz             | ermöglicht den Vehikel- Check mit halbem Schwierigkeitsgrad und das Reiten auf dem Konstrukt. Kleine Rassen können bereits auf mittleren Konstrukten reiten, normal-große Rassen benötigen große Konstrukte |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Pilotensitzpanzerung    | Schützt den Pilotensitz so das nur das Konstrukt attackiert werden kann, Pilot versteckt sich wie Kern hinter der Abdeckung (Called shot)                                                                   |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Utilitywerfer           | Rauch, Seil und Bola dieser Apparatus findet immer etwas zum werfen.                                                                                                                                        |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Rammmodul               | ermöglicht es dem Konstrukt ein Rammmanöver zu starten um einen gegner mit gewisser Chance zu betäuben / zu unterbrechen                                                                                    |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+
| Überladungsblendmodul   | Durch eine Kernüberladung zum Preis von 5 Ladungen werden umstehende Geblendet zusätzlich erhält das Konstrukt schaden.                                                                                     |                |                |                |                |
+-------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------+----------------+----------------+----------------+

### Beispiel Konstrukt Erstellung

Ein Beispiel für die erstellung eines Konstrukts, ein fähiger Händler in der Gruppe hat nach einigem sparen entschieden die Schwäche der Gruppe im Kampf durch ein Konstrukt auszugleichen. Der Gruppe fehlt ein Frontkämpfer, da sich die gesamte Gruppe dafür entschieden hat Stealth Archer zu werden.

Nach dem die generelle Ausrichtung bestimmt ist und ein passender Händler gefunden, beginnt die Auswahl. Als erstes wählt er für die Rolle passend einen Corpus ausgewählt, nicht zu auffällig groß aber auch nicht zu klein. Also wird es ein Mittlerer Corpus mit den Attributen gleichmäßig verteilt zwischen Stärke und Physical, um bestsens Blocken und im Nahkampf angreifen zu können. Dafür betragen die Kosten für T1 12.000R.\
Als nächstes der Kern für 5000, auf niedriger Stufe bietet es sich an in die das Kern-Stufe anstelle von Skill-Level zu investieren für Kernstufe 10 weitere 5.000R.\
Nun noch die Batterie, für 12.500R erhält man eine Batterie mit 10 Ladungen.

Jetzt fehlt nur noch die Ausrüstung, für den Anfang reicht noch das alte Schild und Schwert.

Gesamtkosten wären damit etwa: 34.500 + Ausrüstung

Die werte werden flux in das Muster Excel sheet eingetragen alle anderen Informationen werden automatisch ergänzt also kann es schon losgehen.
