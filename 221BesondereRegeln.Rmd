...
Um ein Lied im Kampf zu singen wird wie normalerweise ein Performace-Check gemacht. Die Wirkung hält vier Aktionen an und es kann nur ein Genre gleichzeitig auf eine Person wirken. Lieder können motivierend sein oder demotivierend sein, also als Buffs oder Debuffs wirken - mit einem Lied des Genres Folk kann man also den Physical-Wert einer Person steigern wenn es motivierend ist und senken wenn es demotivierend ist. Versucht man ein Lied auf eine Gruppe Ziele wirken zu lassen, ist es deutlich schwerer - der Theshold verdoppelt sich. Lieder können - wie fast alles in unserem System - eine Stufe (Tier) von 1 bis 4 besitzen. Diese Stufe macht ein Lied zwar schwerer zu spielen, allerdings wird die Wirkung auch stärker.
...
![Eine umfunktionierte Handelsgaleere[^221besondereregeln-1]](Pictures/Flavor/SchiffeBoote/Wikimedia_Galeere_Transparent.png)

[^221besondereregeln-1]: Diese Abbildung wurde der Seite [wikimedia](https://commons.wikimedia.org/wiki/File:Galley-knightshospitaller.jpg) entnommen und steht unter einer Creative Commons Attribution-Share Alike 3.0 Unported license zur Verfügung.

[^221besondereregeln-2]: Diese Abbildung wurde der Seite [wikimedia](https://commons.wikimedia.org/wiki/File:Galley-knightshospitaller.jpg) entnommen und steht unter einer Creative Commons Attribution-Share Alike 3.0 Unported license zur Verfügung.
...
![Eine Trireme auf Patroullie[^221besondereregeln-3]](Pictures/Flavor/SchiffeBoote/wikimedia_Trireme.png)

[^221besondereregeln-3]: Diese Abbildung wurde der Seite [wikimedia](https://commons.wikimedia.org/wiki/File:Trireme_1.jpg) entnommen und steht unter einer Creative Commons Attribution-Share Alike 2.0 France license zur Verfügung.

[^221besondereregeln-4]: Diese Abbildung wurde der Seite [wikimedia](https://commons.wikimedia.org/wiki/File:Trireme_1.jpg) entnommen und steht unter einer Creative Commons Attribution-Share Alike 2.0 France license zur Verfügung.
...
![Eine Fregatte kreuzt gegen den Wind[^221besondereregeln-5]](Pictures/Flavor/SchiffeBoote/Fregatte_Pixaby.jpg)

[^221besondereregeln-5]: Diese Abbildung wurde der Seite [Pixaby](https://pixabay.com/es/illustrations/vela-barco-mar-1506158/) entnommen und steht zur kommerziellen Nutzung zur Verfügung.

[^221besondereregeln-6]: Diese Abbildung wurde der Seite [Pixaby](https://pixabay.com/es/illustrations/vela-barco-mar-1506158/) entnommen und steht zur kommerziellen Nutzung zur Verfügung.
...
Der Modus Operandi: Ein Konstrukt führt den aktuellen Befehl solange aus bis es einen anderen erhält. Durch Übermittlungszeit ist es nicht möglich reaktionär zu agieren (als Beispiel schütze mich vor diesem angriff) anders sieht es aus wenn der Befehl vorher schon geäußert wurde
...
Jede aktive Anwendung verbraucht Ladungen der Batterie, je nach Art der Anwendung können auch mehrere Ladungen für eine Anwendung verbraucht werden.
...
Zum besseren und einfachen Verständnis der Erstellung eines Konstruktprofil ist ein Blick in die Excel empfohlen. Da mit nur wenigen Eingaben das Konstrukt Session ready ist. Zu beachten ist das die Linke seit des Profil nicht bearbeitet werden sollte da sich diese Werte selbst vervollständigen.
...
-   Corpus gibt die Verfügbaren Attribute.
...
Der Konstruktkern stellt sowohl das Herz als auch das Hirn eines jeden Konstruktsdar Das Level des Kern wird durch das Anwenden von Essenzen in der nebenbei Downtime erhöht Dieses Level beinflusst viele Bereiche des Konstrukts:
...
-   Skill Maximum: die Eigenschaft Utility Konstrukt reduziert den Preis um den Faktor 0,25 jedoch limitiert das Skilllevel auf 50
...
Jedes Attribut startet Standartmäßig auf 1 und kann durch den Corpus oder durch Addons erhöht werden. Addons sind jedoch auf Stärke, Agilität und Physical beschränkt. Mit dem aufsteigen des Konstruktkernlevels erhöht sich außerdem der Wert von Instinkt und Intelligenz.
...
-   Attelerienachlader (automatisch
...
+-------------+--------------+--------------+--------------+--------------+
| Panzermodus | Schildwert + | Schildwert + | Schildwert + | Schildwert + |
+-------------+--------------+--------------+--------------+--------------+
| Pilotensitz |              |              |              |              |
+-------------+--------------+--------------+--------------+--------------+
