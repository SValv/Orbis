...
![Eine Trireme auf Patroullie[^3]](Pictures/Flavor/SchiffeBoote/wikimedia_Trireme.png)

[^3]: Diese Abbildung wurde der Seite [wikimedia](https://commons.wikimedia.org/wiki/File:Trireme_1.jpg) entnommen und steht unter einer Creative Commons Attribution-Share Alike 2.0 France license zur Verfügung.
...
![Eine Fregatte kreuzt gegen den Wind[^5]](Pictures/Flavor/SchiffeBoote/Fregatte_Pixaby.jpg)

[^5]: Diese Abbildung wurde der Seite [Pixabay](https://pixabay.com/es/illustrations/vela-barco-mar-1506158/) entnommen und steht zur kommerziellen Nutzung zur Verfügung.

[^6]: Diese Abbildung wurde der Seite [Pixabay](https://pixabay.com/es/illustrations/vela-barco-mar-1506158/) entnommen und steht zur kommerziellen Nutzung zur Verfügung.
...
+-------------+-------------+--------------+------------------+------------------+
|             | Rüstung     | \| Attribute | \| Preis (Reiks) | \| Utility Preis |
+=============+=============+==============+==================+==================+
...
Der Preis einer Batterie erhöht sich mit der Anzahl der Ladungen und kann nach dem Kauf nicht weiter erhöht werden. Batterien können jedoch gebraucht verkauft werden, wenn ein Upgrade gewünscht ist.

Außerdem können während der Session Essenzen genutzt werden, um die Batterie neu zu befüllen. CROSSREFERENCE (siehe Batterie in Session Aufladen)
...
Ein Konstrukt kann das vollständige Waffenarsenal verwenden, auf das auch Spieler zugreifen können. Zusätzlich noch einige weitere besondere Waffen, wie den Kampfbohrer und den Flammenwerfer.

#### Addons: {#KonstruktAddons}

-   Transport: erhöht die Belastungsgrenze von Konstrukten für Transportgewicht

-   Panzermodus: 100% Block-Chance; Tiers erhöhen den Schildblockwert; deaktiviert Angriffsfunktion

-   Wachmodus: standardmäßig vorhanden, benötigt dennoch einen Erweiterungsslot, läuft über Perception

-   Schützenplatz: zur Bedienung der montierten Artillerie
...
-   Verbaute Artillerie (nur durch Schützenplatz nutzbar) (Tier abhängig wie groß montierbare Waffe) (einklappbar)

-   Artillerienachlader: automatisches nachladen 1 mal pro Runde der Artillerie

-   Deckungsmodul: Das Konstrukt verwandelt sich in eine passive Barrikade hinter der Personen in Deckung gehen können.

-   Bolawerfer: Wirft Bolas

-   Werfer: Seil oder Rauch

-   Rammmodul: ermöglicht Interrupt/ Stun eines Gegners mit einer gewissen Chance
...
Korpus: Mittel, Utility, T1 15.000R= 20 Attribute, 100 Armor
