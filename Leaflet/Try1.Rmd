...
dfGesamt=read_excel("DataCities.xlsx")
options(scipen=999)
...
PolitPolygonsData=read_excel("PolitPolyData.xlsx")
...
dfRegionPolyValues=read_excel("PolygoneRegion.xlsx")
...
RegionPolygonsData=read_excel("DataRegionInfo.xlsx")

RegionenLabels= sprintf(
  "<strong>%s</strong><br/>Hauptstadt: %s<br>Herrscher: %s<br>Bevölkerungsdichte: %s pro Km^2",
  RegionPolygonsData$Name, RegionPolygonsData$Hauptstadt, RegionPolygonsData$Herrscher, RegionPolygonsData$`Nachgefragte Güter`,RegionPolygonsData$`Güter im Überfluss`,RegionPolygonsData$`Wirtschafliche Kraft`
) %>% lapply(htmltools::HTML)
...
```{r Icons, echo=F}
icons=iconList(
  Ausenposten = makeIcon("Marker/Außenposten.png","", 20, 20),
  Grosstadt = makeIcon("Marker/Großstadt.png","", 20, 20),
  Stadt = makeIcon("Marker/Stadt.png","", 20, 20),
  Dorf = makeIcon("Marker/Dorf.png","", 20, 20),
  Farm = makeIcon("Marker/Farm.png","", 20, 20),
  Milizstadt = makeIcon("Marker/Milizstadt.png","", 20, 20),
  Minenstadt = makeIcon("Marker/Minenstadt.png","", 20, 20),
  Natur = makeIcon("Marker/Natur.png","", 20, 20),
  Ruine = makeIcon("Marker/Ruine.png","", 20, 20),
  Schlacht = makeIcon("Marker/Schlacht.png","", 20, 20),
  Wahrzeichen= makeIcon("Marker/Wahrzeichen.png","", 20, 20)
)
```
  ...
  htmlwidgets::onRender(
    "
      function(el, x) {
        console.log(this);
        var myMap = this;
        var imageUrl = 'Orbis%20Aestea.jpg';
