...
Tagsüber wandern Goblins durch die Oberwelt und jagen Wild und plündern teils nicht bewachte Dörfer und Häuser. Zum Leidwesen der Bauern stehlen sie auch, sofern die Goblins nicht mit Menschen in irgendeiner Form affiliert (not sure if des wort passt) sind, wie in den Norser Kanalsystemen, Nahrung aus den Speichern.
...
Die Problematik, um ein wenig genauer darauf einzugehen, besteht nämlich darin, dass die Goblins nach einem (zu) üppigen Mahl, das Potential entwickeln zur Matriarchin heranzureifen. Demzufolge entstehen besagte Spannungen, da dieses Heranreifen bei vielen Goblins gleichzeitig in Gang gesetzt wird und in weiterer Folge ein Machtkampf entsteht. (i guess so läuft des oder ? - ohne de info versteht mans an dem punkt nit ganz)

Im Kampf zeichnen sich Goblins durch besondere Fähigkeiten bei lautlosen Überfällen mit Fernkampfwaffen und Blasrohren mit Giftpfeilen aus. Im direkten Kampf ist diese Spezies den anderen allerdings meist deutlich unterlegen. Lediglich Halblinge sind hier in der selben "Gewichtsklasse".

> "Diese kleinen und irgendwie hässlichen Wesen, sind weder robust noch stark, noch mit dem Intellekt (im absatz davor steht im ersten satz dass se gleich klug sen wie menschen und im ersten absatz in dem kapitel steht, dass se ah"basale" kultur sen .. wos jz?) ) anderer Rassen beschenkt, doch all diese Unfähigkeiten gleichen sie durch ihre agile und hinterhältige Natur aus. Goblins brillieren, wo andere Rassen verzweifeln - Nachts und in dunklen Tunneln. Nur jene, die noch nie auf eine Horde Goblins getroffen sind, halten Elfen für die Könige der Nacht. Denn im Unterschied zu den Elfen gibt es vor den Goblins kein verstecken."
>
