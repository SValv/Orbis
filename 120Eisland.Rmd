...
### Die Höhle von Khazak {#TheCaveOfKhazak}
...
Einige der sehenswertesten Orte im Eisland gehören zu den Sammelplätzen der Animali. Dazu gehören <font color="green">[The mountaing top of Sro](#Sro)</font> und auch die Orte <font color="green">[Die Höhle von Khazak](#TheCaveOfKhazak)</font>, an denen sich die Animali bekanntlich versammeln. Khazak ist der einzige Ort, an dem sich alle Animali-Stämme jedes Jahr versammeln, und obwohl kein Mensch die Höhle je betreten hat, soll sie eine wahre Augenweide sein.

### Feiertage

```{r}
getFeiertage("Eisland")
```
