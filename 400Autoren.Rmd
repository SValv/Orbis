# (PART) Zum Projekt Orbis Astea {-} 

# Das Team hinter Orbis Astea {#Team}
...
* 01.09.21 Orbis Astea 3.0

## Die Autoren {-}
 
### Simon Valverde {-}

<div style="float:left; position:relative; right:30px; top:-7px;  overflow:hidden;">

![](Pictures/Team/Simon.jpg){width=250px height=300px}
...
![](Pictures/Team/Lena3.jpg){width=250px height=300px}
...
![](Pictures/Team/Emil.jpg){width=250px height=300px}
...
![](Pictures/Team/Kasper.jpg){width=250px height=300px}
...
Kasper ist ein starker Befürworter und Unterstützer des Projekts von Anfang an. Besonders im Beginn der Entwicklung unserer Welt hat er viele Ideen eingebracht und die Gestaltung Orbis‘ maßgeblich beeinflusst. Seine Bereiche liegen aktuell in der Entwicklung weiterer Lore, sowie seiner Position als Side-DM. Insbesondere durch diese Funktion hilft er viel weiter, da er auf diesem Wege Simon die notwendige Auszeit und Freude am Spiel durch eigenes Charakterplay ermöglicht. Besonders zu erwähnen ist, dass er Bereit ist sich in viele Bereiche reinzuarbeiten und einen unglaublichen Enthusiasmus an den Tisch zu bringen.

### Florian Berger {-}

<div style="float:left; position:relative; right:30px; top:-7px;  overflow:hidden;">

![](Pictures/Team/Florian.jpg){width=250px height=300px}
...
![](Pictures/Team/Andi.jpg){width=250px height=300px}
