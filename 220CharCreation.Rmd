...
Zusätzlich zu den "harten" Eigenschaften gibt es noch sogenannte Wissens-Skills.
Diese sollten mit der Backstory verknüpft sein und können in diesem Rahmen frei gewählt werden.
Sie fließen eher als Hintergrund-Eigenschaften mit ein, da sie nicht direkt über Proben irgendeiner Art geprüft werden.
Wenn der DM irgendwelch Hintergrund-infos hat die jemand mit entsprechendem Wissens-Skill wissen müsste, sollte der Spieler diese Infos auch haben.
...
Wissens-Skills berechnen sich aus der Intelligenz der Person nach der Character-Creation.
Bei Intelligenz 10 sind es drei Wissens-Skills, für abweichende Werte wird prozentuell auf oder abgerundet.

### Sprachen

In Orbis Astea gibt es viele Sprachen.
Die Menschen haben in jeder Fraktion unterschiedliche Sprachen, wobei die Sprache Eldrias und die des Rechs sehr ähnlich ist.
Orks sprechen eine sehr einfache Sprache namens Orkisch - das noch Informationsärmer ist als das Gob der Goblins.
Elfisch ist eine sehr hohe Sprache, die aber nur noch die Waldelfen wirklich sprechen.
Ahnlich wie die Halblinge - die aber auch ihren eigenen Dialekt haben, der schwer verständlich sein kann wenn sie es wollen - sprechen Stadtelfen meistens die Sprache der Menschen.

Die Sprachfertigkeit kann von 1-10 gehen.
10 ist das Niveau eines gebildeten Muttersprachlers, mit 6-7 kann man flüssige Gespräche führen, mit 3 kann man stockende Alltagsgespräche führen und mit 1 kann man nur einzelne Worte austauschen.

Sprachen öffnen viele Türen und Tore und sollten vom DM gerade beim social play beachtet werden.

Jede Rasse hat ihre Startsprache und zusätzlich dazu Sprachpunkte in Höhe von (Intelligenz+Instinct)/4, die einfach auf Sprachen verteilt werden können.
Dies sollte aber gerade bei guten Kenntnissen in die Backstory eingebaut werden.

### Kontakte

Kontakte sind ein weiteres Stück der Welt - sozusagen das soziale Kapital des Spielers.
Sie helfen an Aufträge, Informationen und andere Dinge zu kommen für die Vitamin B nun mal nützlich ist.
...
Loyalität ist eine Skala, die von 1 bis 7 geht.
Während eine Loyalität von 1-2 nützliche Geschäftskontakte darstellt würde man 5 als enge Freundschaft, 6 als Beziehung und 7 als liebende Familie/lebenslange Ehe Bezeichnen können.
Gerade tiefere Kontakte müssen in der Backstory begründet sein.

Bei Einfluss geht die Skala von 0 bis 12, wobei 0 den Penner auf der Straße darstellt und 12 der Kaiser höchstselbst ist.
Werte über 7 müssen gut begründet werden, während Werte über 9 gänzlich unmöglich sind.
...
Ebenso wie bei Glaube kann auch das Glück sinken und steigen. Wenn ein Charakter beispielsweise Aktionen bringt die gegen seine eigenen Werte gehen, sinkt der Glückswert durch Ansage des DM's. Bei Aktionen auf die ein Charakter besonders Stolz sein kann steigt dieser wieder. Die stärke von Senkung/Steigung liegt am DM. 

Dieser Wert soll das persönliche Wachstum und Wohlbefinden wiederspiegeln.

### Sanity

Sanity bezeichnet die Rate, in der der Charakter noch Zurechnungsfähig ist. Sie geht vom Maximalwert 100 bis zum Wert Null. Sanity sinkt jedes Mal, wenn man mit Blutgöttern in Kontakt kommt, Blutgöttern dient oder eine Blutgottwaffe verwendet. 
Solange die Sanity über 20 ist gibt es noch nichts zu befürchten. Sinkt die Sanity unter 20, hat der DM einmal pro Session die Möglichkeit einen Glück/Glaube-Save zu machen und - falls dieser gefailt wird - übernimmt der DM kurzzeitig die Kontrolle über die Figur, die daraufhin Wahrscheinlich horrende Taten vollbringt. Sinkt die Sanity unter 10, hat der DM zwei mal pro Session die Chance auf die Übername des Charakters. 
