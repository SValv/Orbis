...
|  Rassenfähigkeiten   |            | Nachtsicht |  Geldgeil  | Kurzsichtig |  Mutation  | Thermo-sicht | Unverdächtig |
...
Neben der individuellen Skill Verbesserung haben die Spieler auch die Möglichkeit, eine Skill Gruppe auszuwählen. Dies hat den Vorteil, dass alle Skills in der ausgewählten Gruppe gemeinsam zu einem durchschnittlich günstigeren Preis verbessert werden, als wenn sie einzeln aufgewertet werden würden.
Die Gruppen haben unterschiedliche Skills, diejeweils  zum Berufsbild passen. Außerdem haben die Skill Gruppen auch unterschiedliche Kosten, die an die Menge und Stärke der Skills angepasst sind.
Investiert man in eine Skillgruppe, kann dies nur bis Level 40 erfolgen. Entscheidet sich ein Spieler zum Beispiel dafür, die Ritter Skillgruppe (wobei Armed enthalten ist) bis Level 30 zu verbessern, kann man auch noch weitere Punkte in Söldner investieren (hier ist Armed auch inkludiert) bis Armed einen Wert von 40 erreicht. Investiert man mehr Punkte in Söldner, bleibt Armed auf 40, die anderen Skills nehmen noch zu.
