...
Orbis Astea ist ein Open Source Pen and Paper Rollenspiel, welches von einem deutschsprachigen [Team](#Team) entwickelt wird. Momentan ist es zum kostenlosen [Download](DMAppDownload) über diese Website verfügbar. Die Idee von Orbis Astea besteht darin einen flüssigen und einfachen Spielspaß für Spieler und DM zu garantieren, während Regeln und Abläufe so automatisiert und einfach wie möglich zu halten. Gerade für Spieler ist Orbis Astea ein einfach zugängliches und schnell erlernbares System (einen Spieler spielfähig zu machen dauert 15 Minuten bis eine Stunde). Auch hat Orbis Astea den Vorteil, dass Aktionen sehr schnell durchführbar sind. Außerdem bietet Orbis Astea viele zusätzliche Funktionen wie eine vielzahl direkt spielbarer und dennoch leicht unterschiedlicher Profile für NPCs, automatische Händlerinventare, anonyme Charaktersheets und und und - am besten probiert man es einfach aus. Orbis Astea benötigt einen Computer auf dem der DM das Programm ausführt.

Orbis Astea ist ein low-fantasy Setting, welches kein aktives Magiesystem besitzt. Das System selbst funktioniert mit jedem Worldbuilding welches ähnliche Umstände hat - also etwas näher an der Realität ist - allerdings funktioniert das System natürlich am besten mit der Lore von Orbis Astea - da viele Gegenstände und manche Mechaniken an diese Welt angepasst sind.
