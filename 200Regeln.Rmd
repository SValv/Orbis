...
* Einschüchtern: Intimidation gegen Insight mit Expirience als Attribut
...
Manchmal gibt es Modifikatoren auf Attributes oder auf Skills, diese sind nur für kurze Zeit (Maximal die Session) aktiv und werden im Character-Sheet auf der Status Page bei Modifikator eingetragen. Sie sind für den Wert des Attributs/Skills zu addieren bzw. abzuziehen.
...
Der Toxikologie-Safe wird mit den Würfeln der Attribute Physical Expirience Luck und Glaube gewürfelt - Achtung hierbei wird die Summe, nicht der Durchschnitt gebildet.
...
Dies ist mit Abstand der häufigste Save und wichtigste Save. Hierbei wird die Summe (wieder nicht der Durchschnitt) der Attribute Luck und Glaube als Threshold gebildet. Dieser Save wird immer geworfen wenn der DM nicht sicher ist ob positive oder Negative folgen eintreten. Hierbei wirft der DM einen D20 Würfel, wenn der geworfene Wert unter em Threshold liegt tritt die positive Folge ein, andernfalls die negative. 
...
Beim Reiten sind ein paar Dinge zu beachten. Neben der Tatsache das Reittiere extra <font color="green">[Unterhalt](#Lebenserhaltungskosten)</font> kosten sind zwei Skills notwendig um ihr volles Potential zu nutzen - Reiten und Animal Handling. Reiten determiniert wie gut man sich auf dem Reittier halten und agieren kann, bzw das Reittier steuern kann. Animal Handling determiniert wozu man das Reittier sonst bringen kann. Dies kann vor allem für spezielle Aktionen notwendig sein.
...
Der Kampf ist wie in jedem Pen- and Paper-System eine der komplizierteren Vorgänge. In Orbis Astea läuft viel über ein Programm, was alles deutlich erleichtert und schneller macht. im allgemeinen versucht das System das Spiel so flüssig wie möglich zu halten. 


### Die Initiative {#Initiative}

Am Anfang des Kampfes findet die Initiative statt, d.h. jeder wirft Initiative (Expirience + Physical)/2. Die Werte werden nach größe geordnet und der mit dem höchsten Wert darf angreifen, dann der mit dem zweithöchsten und so weiter. Manchmal legt der DM diese Reihenfolge sinngemäß fest (bspw bei Schleichangriffen oder Distanz und Fernkämpfern).
...
| Verbündetem helfen        | Blocken/Ausweichen                   |
...
| Laden der Artillerie      | Angriff Unarmed/Dual wield/Wurfwaffe |
...
Die Bonus Action ist eine weitere single Action, diese ist aber normalerweise nicht verfügbar und wird nur selten durch gewisse Buffs oder den DM gewährt.

Die Bonus Action kann - genauso wie die single Action - für die Runde des Gegners gespart und jederzeit eingesetzt werden.

#### Blocken und Ausweichen {- #BlockenAusweichen}

Auf jeden Angriff kann mit Blocken oder Ausweichen reagiert werden. Blocken ist dabei ohne zweifel die stärkere Wahl, allerdings verliert man dabei eine Hand an einen Schild und kann keine Großwaffen mehr benutzen oder dual wielden, denn ohne einen Schild ist das Blocken nicht möglich.

Wenn man noch eine single/bonus Action übrig hat kann man einen Angriff mit einer Wahrscheinlichkeit von 100% Blocken oder Ausweichen. 

Wenn man keine Action mehr hat kann man mit einer Wahrscheinlichkeit von 60% blocken und von 20% ausweichen.

![Schematische Übersicht über die Kampfrunde](Pictures/Rules/Attack.png)

#### Parieren {-}

Parieren bezeichnet das Abwehren von Nahkampfangriffen mit der Nahkampfwaffe. 
Beim Parieren besteht eine erhöhte Wahrscheinlichkeit den Zustand der Waffe zu verringern. 


#### Deckung {-}

Die Deckung stellt eine Alternative zu Blocken/Ausweichen dar. Deckung kann nur Fernkampfangriffe abwehren, Nahkampfgegner werden von Deckung nicht berührt/berücksichtigt, da sie einfach außen herum gehen können. In Deckung gehen kostet eine single action, sollte die Deckung vor dem Feindlichen angriff nicht deklariert sein, braucht man einen Acrobatics-Check um in Deckung zu gelangen. Ansonsten tritt der normale Ablauf ein (Block/dodge, mit Chance bei keiner freien Action).

Es gibt zwei Arten von Deckung - die natürliche und die aufbaubare. Jede Aufbaubare Deckung braucht eine single und eine Main action. 

Die Deckung hat eine prozentuelle Chance den Angriff vollständig zu anulieren. Je umfangreicher die Deckung, desto höher diese Chance. Für jeden halben m² beträgt die Chance nicht getroffen zu werden 30% (Dies ist ein Richtwert, die Details unterliegen der Einschätzung des DMs). Je nachdem wie groß der betreffende Charatker ist, ist diese Chance zu erhöhen oder zu senken. **?** Anpassung Rassengröße: Kleine Charaktere haben somit mit keinen Debuffs zu rechnen, bei mittel-großen Charakteren betragen die Debuffs 5% und bei großen Charakteren betragen diese 10%.
Sobald man in Deckung ist, hat man keinen direkten Überblick über das Schlachtfeld mehr. 
...
Instrumente haben Slots für Buffs und Debuffs. In jeden Slot passt ein Effekt. Ein Effekt hält 2 Runden an und muss dann erneuert werden. Zum Erneuern muss zuerst als Main Action eine Probe auf Performance gespielt werden, je nach Effekt ist der Threshold ein anderer.
...
Ganz mutige Wesen versuchen mit zwei Waffen zu kämpfen. Dies kann vor und nachteile mit sich bringen. Ein Nachteil dabei ist das man nicht blocken kann. Ein Vorteil ist, dass man auch in der single Action mit einer Waffe zuschlagen kann. 
Allerdings wird der Schaden mit jeder Sekundärwaffe außer Dolch und unbewaffnetem Angriff nur zu 70% umgesetzt.
Bei Dolchen kommt 90% des Schadens durch, bei unbewaffneten Angriffen sind es 100%.
Des weiteren sind beim Dual Wielding (mit nicht-Faustwaffen) gewisse Aktionen unmöglich - da beide Hände vollbesetzt sind. So gibt es wenn man einen Trank verwenden will eine 50% Chance, dass dieser zu Boden fällt und damit verbraucht und nicht eingenommen werden kann, oder bspw. Wurfwaffen auch nicht einsetzbar sind.
...
Beim Schleichangriff wird immer ad atvantage geworfen, wobei 3 mal geworfen wird. Außnahme davon ist der Dolch und die Armbrust - bei der Armbrust wird 4 mal, beim Dolch kommt es zum Attentat.
...
#### Negative Modifikatoren beim Schleichen {-}

* Aktives Gewicht größer als 20 Kilo: Disatvantage Level 2
* Aktives Gewicht größer als 30 Kilo: Disatvantage Level 3

#### Das Attentat {-}

Wenn ein Sneak Attack mit einem Dolch stattfindet wird es bei geringeren Gegnern zum Attentat. Das Attentat tötet den Gegner direkt. 
Sollte der DM da was dagegen haben, ist das normale Prozedere mit Advantage 5 geworfen. Dies trifft vor allem auf Monster und bestimmte Charaktere zu bei denen es nicht glaubhaft ist, dass ein Attentat ausreichend ist. Sollte der DM das Attentat verneinen, wird der Schaden der versuche stattdessen kummuliert.

### Called Shots

Manchmal will man einen Speziellen Teil des Gegners angreifen. Das nennt man einen Called Shot. Hierbei wird allerdings die Trefferwahrscheinlichkeit - und dadurch der Schaden - stark verringert, je nachdem wo man vorhat zu treffen.
...
### Objekte während dem Kampf

Objekte können während dem Kampf als single Action verwendet werden. Wichtig hierbei ist allerdings dass man sie bereits in der Hand, im Holster (bei Waffen) oder in der Tranktasche (bei Tränken) trägt. Alles was aus dem Rucksack - also dem übrigen Inventar - geholt werden muss, kostet eine Main Action.
...
Ein einziges <font color="green">[Faustmesser oder ein Schlagring](#Faustwaffen)</font> kann auch in einer Hosentasche versteckt werden, Damit kann der Gegenstand auch mit einer single Action gezogen werden.
...
Eine Formation ist nur möglich, wenn das Terrain das auch zulässt.
...
3. Vor dem Angriffswurf wird eine Probe auf Reiten geworfen die entscheidet wieviel vom Mount-Multiplikator des Reittiers durchkommt.
...
|  Balliste  |          2         |          3         |       Holz      | Mittel | Nachladen 1 Runde minimum, <br>2 Runden wenn besatzung <2                      |
| Handkanone |          1         |          1         |       Holz      | Klein  | Nachladen 1 Runde                                                              |
| Großkanone |          2         |          3         |      Stein      | Groß   | Nachladen 1 Runde minimum, <br>2 Runden wenn besatzung <3                      |
|  Katapult  |          2         |          3         | Schwacher Stein | Mittel | Nachladen 1 Runde minimum, <br>2 Runden wenn besatzung <3,<br> Area Damage 2m  |
| Trebouchet |          4         |          8         |      Stein      | Groß   | Nachladen 1 Runde minimum, <br>2 Runden wenn besatzung <6 ,<br> Area Damage 8m |
...
Sämtliche Ausrüstung, Tränke, Waffen, Instrumente, etc. kommen in Orbis Aestea in sogenannten "Tiers" oder Stufen. Umso höher die Tier, desto besser und wertvoller die Ausrüstung. 
...
In Orbis Astera gibt es verschiedene Währungen, während im Kaiserreich Reiks die bezeichnende Währung ist sind es bei den Rah Kari die Tempelmünzen. Zwergenkronen ist selbstverständlich die normierte Währung der Zwerge. Das Seevolk und die Bürger der Skaen verwenden die Währung der Thaler.
