...
* Einschüchtern: Intimidation gegen Insight mit Experience als Attribut
...
Der Toxikologie-Safe wird mit den Würfeln der Attribute Physical Experience Luck und Glaube gewürfelt - Achtung hierbei wird die Summe, nicht der Durchschnitt gebildet.
...
Des Weiteren sind beim Dual Wielding (mit nicht-Faustwaffen) gewisse Aktionen unmöglich - da beide Hände vollbesetzt sind. So gibt es, wenn man einen Trank verwenden will, eine 50% Chance, dass dieser zu Boden fällt und damit verbraucht ist und nicht eingenommen werden kann, oder bspw. auch Wurfwaffen nicht einsetzbar sind.
...
* Aktives Gewicht größer als 20 Kilo: Disadvantage Level 2
* Aktives Gewicht größer als 30 Kilo: Disadvantage Level 3
