...
|        | Leben |                 Beispiele                 |
|--------|:-----:|:-----------------------------------------:|
| Tier 1 |  300  | Schlechte Holzdeckung/Dreckshaufen/Pavese |
...
Eine weitere Strategie gegen Deckung ist das "ansitzen". Hierbei deklariert ein Angreifer als Main Action eine Deckung und achtet genau auf sie. Dies führt dazu, dass er auf ein beliebiges Ziel, dass hinter der Deckung hervorkommt oder hervorschaut einen Angriff ad Advantage ausführen kann. Sollte ein Wesen während dem ansitzen allerdings einen anderen Check werfen müssen wirft es diesen ad Disatvantage und verliert den Fokus auf die Deckung (damit ist das ansitzen beendet).
