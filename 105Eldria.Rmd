...
![Ein Ritter Eldrias, der Löwe von Calvert ziert sein Wappen](Pictures/Flavor/Eldria/blackmoors_knight_by_umbatman.jpg)
[^Künstler2]
Die meisten Ritter tragen einen Überwuf über ihrer Rüstung, der in leuchtenden Farben sowohl das Wappen des Ritters selbst, als auch die Insignien des Fürsten dem sie dienen, sofern sie in einem Dauerverhältniss sind

Meist sind es besonders treue Ritter, die in den Adelsstand erhoben werden und so ist der Ritterstand gerade für viele soziale Aufsteiger oder niedere Adelige, die nach mehr Land und Macht streben und sich durch eine mögliche Erhebung erhoffen an tatsächlichen Einfluss zu kommen, attraktiv.
...
Nach dem Untergang Wandias erklärte Gent beihnahe unmittelbar seine Unabhängigkeit und begann seinen Einfluss in umliegende Fürstentümer auszuweiten.
...
Durch den Felssturz von Istval wurde Gent geschwächt und musste dadurch sämtliche Hoffnungen, in näherer Zeit die Führungsrolle in Eldria zu übernehmen, aufgeben.

Gent war eines der Fürstentümer - das größte davon um genau zu sein - welches sich nach dem Krieg dem Kaiserreich angeschlossen hat. Dies hatte vor allem den Vorteil, dass die Familie Strake weiterhin die Herrschaft über Gent behalten durfte. Natürlich ist Gent dem Kaiserreich gegenüber nicht *wirklich* Loyal - so haben sie im großen Krieg die Kaiserlichen mit allem bekämpft, was sie hatten - viel mehr geht es ihnen darum ihre Macht unkompliziert zu behalten und weiter auszubauen, während das Kaiserreich unter der Hand mit allen verfügbaren Mitteln bekämpft wird. 
...
Des Weiteren hat Darcy eine Menge an indirektem Einfluss auf andere Fürstentümer, da in Darcy eine Lösung hergestellt wird, die die Erweckung verhindert. Diese Lösung wird "Traum der Seeligen" genannt und ist ein, speziell von Priestern und der Chromatia Narista, geweihtes Wasser, welches die effizienteste bekannte Lösung darstellt, um die Erweckung zu verhindern. 
Darcy versucht den Verkauf dieses Mittels zu verwenden, um andere Fürstentümer zur Zusammenarbeit und zu Friedensverträgen zu nötigen, teilweise obwohl keine der streitenden Parteien Frieden will, geschweige denn eine Einmischung Darcys in ihre Affären schätzt. Diese aggressive Politik hat auch dafür gesorgt dass Darcy und dessen Religion in der Außenwelt bei weitem nicht so beliebt und damit einflussreich ist wie andere Konfessionen in Orbis Astea, deren Lösung für die Erweckung komplexer sind als die der Religion Darcy's.
...
In beiden Städten gab und gibt es immer wieder systematische Hexenjagdten, die vor allem Drogensüchtige und Alchemisten treffen. Die größte davon war im Jahr 184 nach Riga, in der über 400 Personen öffentlich verbrannt wurden - alles unter Aufsicht der Wahrer des Hains. 
...
[^Künstler2]: "Blackmoors Knight" von [Umbatman](https://www.deviantart.com/umbatman/art/Blackmoors-Knight-846222925). Dieses Artwork steht unter einer Creative Commons Attribution-Noncommercial-No Derivative Works 3.0 License zur Verfügung.
