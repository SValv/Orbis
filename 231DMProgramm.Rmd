...
**Tipp: **es lohnt sich den Ordner "ZZZ Character Sheets" innerhalb des entpackten Ordners per Cloud an die anderen Spieler freizugeben, da diese dann automatisch ihre Char-sheets dort hinein synchronisieren können und Neuerungen damit immer aktuell sind.
