...
Der Ausdauersave passiert automatisch bei jeder Aktion die die körperliche Ausdauer belastet. Er wird mit dem Physical-Wert abgezogen dem <font color="green">[Aktiven Gewicht/5](#AktivesGewicht)</font> gewürfelt. Die negative Differenz wird der Ausdauer abgezogen. Warum Ausdauer und dieser Save wichtig sind steht <font color="green">[hier](#Ausdauer)</font>.
...
***Optionsangriff raus, kein scaling***
...
Auch andere Angriffe können als Single Action durchgeführt werden. Dazu zählen <font color="green">[kleine Wurfwaffen](#WurfWaffen)</font> und unbewaffnete Angriffe wie bspw. ein Faustschlag, sowie Bogen und Schleuder fernangriffe.
...
Beim Schleichangriff ist keine Abwehraktion des Gegners möglich, sonst läuft der Schleichangriff wie ein normaler Angriff. Außnahme davon ist der Dolch dieser ermöglicht ein direktes Attentat =\> also eine direkte tötung des Ziels.
