...
Die einfache Probe ist zu Würfeln, wenn es keinen direkten Gegenspieler gibt. Sie ist meistens mit einem Threshold in Value[^value] oder Damage verknüpft, den der DM beliebig festlegt. Sollte man bspw. versuchen ein Schloss zu knacken, wird der DM festlegen, dass der Value über 3 sein soll, um das zu erreichen. Bei härteren/leichteren schlössern ist der Value natürlich anzupassen.

[^value]: Value ist eine Form von Gütekriterium eines Wurfes - je höher der Value, desto besser der Wurf.
...
Beim Blocken ist es möglich den Gegner zu entwaffnen, dies passiert bei einem guten Block abhängig vom [Schild](#Schilde)
