...
Grapple läuft ebenso wie Pugilismus mit der Fähigkeit "unbewaffneter Nahkampf" - macht allerdings keinen Schaden, sondern ist dazu da den Gegner umzuwerfen oder festzuhalten - und ihn anschließend ganz Auszuknocken. Bei erfolgreichem Grapple hält der Angreifer den Verteidiger fest - entweder im stehen oder auf dem Boden. Weder der Angreifer noch der Verteidiger sind während einem Grapple fähig, [Abwehraktionen](#BlockenAusweichen) einzusetzen. 
Während der Angreifer den Verteidiger grappelt, kann er einmal pro Runde einen unbewaffneten Angriff auf den Verteidiger starten, ohne dass dieser eine Abwehraktion hat. Der Verteidiger kann jede Runde versuchen sich aus dem Grapple zu befreien, dazu muss er einen Grapple-Check gegen den Angreifer gewinnen - danach ist der Grapplevorgang automatisch beendet. Sollte eine Person sich mehr als drei Runden im Grapple befinden, wird sie [ohnmächtig](#Ohnmacht).
Versucht ein Charakter einen anderen zu Grapplen, kann dieser entweder mit der [single action oder der Passivchance ausweichen](#BlockenAusweichen), oder sich auf das Handgemenge einlassen.

Achtung: Grappling ist risikoreich, da man wenn es schlecht läuft selbst niedergerungen werden kann. Auch andere Gegenmaßnahmen wie Dolche können sehr effektiv sein gegen einen Festhalteversuch.

Oft macht es Sinn, diese Aktionen in Verbindung miteinander einzusetzen - so kann in einer Runde ein Charakter beispielsweise in einer Runde gleichzeitig mit der single Action angreifen und mit der Main Action ein Grapple starten.
