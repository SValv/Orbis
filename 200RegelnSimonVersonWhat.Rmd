...
Der Vorteil des Parierens liegt allerdings darin, dass man keine zusätzlichen Einbußen von Optionen hat (wie bspw. beim Schild, wo man eine Hand auf den Schild verwendet). Das Parieren ist also eine "kostenfreie" Option, dort wo ein Block unmöglich wird. Allerdings kann nur ein Nahkampfangriff pariert werden. 
...
Die Deckung hat eine prozentuelle Chance den Angriff vollständig zu anulieren. Je umfangreicher die Deckung, desto höher diese Chance. Denn die Wahrscheinlichkeit nicht getroffen zu werden entspricht ungefähr den % vom Körper, die durch die Deckung verdeckt wird mal 0.75. Damit haben kleinere Charaktere einen Vorteil, um diesen nicht allzusehr zu erhöhen wird dabei immer von einem normalgroßen Körper ausgegangen (Mensch) und kleine Rassen bekommen eine 5% höhere Wahrscheinlichkeit, während große Rassen eine 5% niedrigere bekommen.

Sobald man in Deckung ist, hat man keinen direkten Überblick über das Schlachtfeld mehr, was einem das strategische Handeln durchaus erschweren kann. Der DM entscheidet, wie genau dies zu implementieren ist. Empfehlenswert ist davon auszugehen, dass der Spieler über gewisse Infos nicht verfügt.
...
Eine weitere Strategie gegen Deckung ist das "Ansitzen". Hierbei deklariert ein Angreifer als Main Action eine Deckung und achtet genau auf sie. Dies führt dazu, dass er auf ein beliebiges Ziel, das hinter der Deckung hervorkommt oder hervorschaut, einen Angriff in der gegnerischen Runde ausführen kann, die Verteidigung wird at disadvantage geworfen. Sollte ein Wesen während des Ansitzens allerdings einen anderen Check werfen müssen, wirft es diesen at disadvantage und verliert den Fokus auf die Deckung (damit ist das Ansitzen beendet). Während man ansitzt kann man nicht mithilfe einer Single Action eine Abwehraktion (Block,Dodge,Parieren) starten, sondern der Würfel entscheidet.
...
Das Instrument zu spielen ist auch wieder eine Main Action. Die möglichen Buffs der Instrumente <font color="green">[sind hier gelistet](#WirkungBuffs)</font>.
...
Beim Schleichangriff wird immer at advantage geworfen, wobei drei mal geworfen wird. Außnahme davon sind der Dolch und die Armbrust - bei der Armbrust wird vier mal gewürfelt, beim Dolch kommt es zum Attentat.
...
Common Knowledge: 
für jeden von Anfang an Verfügbar, muss nicht erlernt werden
Religion, Völker, Großreiche, Karte

Vertiefte Knowledge:
•	Territorial Knowledge: gepflogenheiten, besonderheiten, wichtige personen, Heraldik
•	Völker vertieft: Gewohnheiten, Rituale, besondere Orte, 
•	Geographie: Wissen um Städte, routen, 
•	Taktik: Geteilt in Krieg und Schlacht. Schlacht: Vermutlich Taktik der Feinde, beste eigene Formation. Krieg: 
•	Pflanzenkunde: Wissen um alternative effekte von Pflanzen (werwolf pille und co(quest relatet stuff))
•	Handwerk: Materialkunde, Spezielle Waren? (Tranktasche)
•	Handel: In 3 Stufen jeweils vertieft: Handelswaren, Handelsrouten, Preise, Händlerwissen
•	Jagt: Spuren erkennen und lesen, vermutliche Beute sammelpunkte wie Wasserlöcher finden, bekannte beute Tiere der Region
•	Monster: Monster erkennen und deren stärken schwächen, Fährten und hinweise deuten
•	Tiere: Seltenere Tiere erkennen, den Zustand erkennen (erschöpft(relevant für reiten) , verängstigt) 
•	Kriminalität: Gang members und kriminelle Strukturen schnell erkennen und analyisieren (botennetzwerke), mögliche Verstecke, übliche Verhaltensweisen
•	Diebstahl Einbruch: Gute ziele, mögliche wege in häuser
•	Survival: Wasser, Nahrung und Unterschlupf in => Untergruppen: Wüste, Wald, Steppe, Kälte, Berg
•	Architektur: Aufbau von Häusern (reginonal), schwachpunkte in mauern und gebäuden erkennen(verstärken, schwächen)
•	Seefahrt: Strömungen, Schiffs klassen+stärken+schwächen erkennen, Winde günstig erwischen, bedienung höher klassiger Schiffe



Besondere Knowledge:
Blutgötter: Stufe 1 bekanntere, Stufe 2 unbekanntere, special Eigener Blutgott
